...
import com.articles.data.persistence.InsertRowException;
...
class ArticleServiceTest {
    ...
    void shouldUpdateArticles() {
        ...
        assertDoesNotThrow(() -> articleService.update(userID, articles));
        verify(simpleDatabase).update(userID, articles);
    }
